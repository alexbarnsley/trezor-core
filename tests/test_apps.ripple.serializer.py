...
class TestRippleSerializer(unittest.TestCase):
    ...
    def test_transactions(self):
        ...
        common = RippleSignTx(None, 'r3P9vH81KBayazSTrQj6S25jW6kDb779Gi', 10, None, 1)
        ...
        common = RippleSignTx(None, 'r3kmLJN5D28dHuH8vZNUZpMC43pEHpaocV', 99, None, 99)
        ...
        common = RippleSignTx(None, 'rGWTUVmm1fB5QUjMYn8KfnyrFNgDiD9H9e', 15, 0, 144)
        ...
        assert serialize(common, tx_type) == unhexlify('12000022000000002400000090614000000000030d4068400000000000000f8114aa1bd19d9e87be8069fdbf6843653c43837c03c6831467fe6ec28e0464dd24fb2d62a492aac697cfad02')
        ...
        tx_type = RipplePaymentTxType(25000000, 'rBqSFEFg2B6GBMobtxnU1eLA1zbNC9NDGM')
        # 2ef72d50ca removed from the test vector because destination tag is not supported
        assert serialize(common, tx_type) == unhexlify('120000220000000024000000016140000000017d784068400000000000000c8114e851bbbe79e328e43d68f43445368133df5fba5a831476dac5e814cd4aa74142c3ab45e69a900e637aa2')
